...
function ParticleSystem(x, obj) {
  ...
  this.createDraw = function() {
    let drawString = "";
    if(this.trails) {
      drawString += `this.context.fillStyle = '${getComputedStyle(document.getElementById("particle")).getPropertyValue('background-color')}'; this.context.globalAlpha = ${this.trailLength};`;
